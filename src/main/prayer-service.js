...
/*
 * prayer-service.js
 * طبقة البيانات: تجلب مواقيت الصلاة وتحسب الصلاة القادمة والعد التنازلي.
 * لا تعتمد على Electron حتى تكون قابلة للاختبار بشكل مستقل عبر Node.
 */

const fs = require('fs');

const API_BASE = 'https://umqserv.ummulqura.org.sa/api/v1/Prayer';
...
// المناطق الـ13 تؤخذ مواقيتها كما هي من المصدر الرسمي.
// المحافظات تُحسب من إحداثياتها، «مثبَّتة» على مواقيت منطقتها
...
/** مواقيت الصلاة بالدقائق منذ منتصف الليل بتوقيت السعودية لإحداثيات معيّنة. */
